...
*--------------------------------------------------
Electrode {   
  { name="pContact" voltage= 0.0 resist= 1e-6 }
    * Schottky Barrier = 2.8
  { name="nContact" voltage= 0.0 resist= 1e-6 } 
...
Physics (MaterialInterface="Silver/Aluminum") 
{ Recombination(surfaceSRH) 		
}
Physics (MaterialInterface="PCBM/Aluminum") 
{ Recombination(surfaceSRH) 		
}
Physics (MaterialInterface="Perovskite/MEO_2PACz") 
{ Recombination(surfaceSRH)
} 
Physics (MaterialInterface="PCBM/Perovskite") 
{ Recombination(surfaceSRH) 		
}
Physics (MaterialInterface="PEDOT/MEO_2PACz") 
{ Recombination(surfaceSRH)
} 
Physics (MaterialInterface="PEDOT/Nanowires_v2") 
{ Recombination(surfaceSRH)
} 
*--------------------------------------------------
Math{
