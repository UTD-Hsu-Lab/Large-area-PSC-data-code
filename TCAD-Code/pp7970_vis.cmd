...
load_file n7969_des.plt -name Plt_IV
...
export_curves {j} -plot PlotIV -filename /jumbo/scheidelerlab/Vann/pin_resistivity_2d_mobility/n${n}_iv_original.csv -format csv -overwrite
