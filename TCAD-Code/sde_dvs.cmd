...
(sdedr:define-constant-profile "PEDOTDoping" "BoronActiveConcentration" 2.5e+21) ;originally 2.5e21
(sdedr:define-constant-profile-material "PEDOTDopingPlacement" "PEDOTDoping" "PEDOT")

(sdedr:define-constant-profile "nanowireDoping" "BoronActiveConcentration" 2.5e+19)
(sdedr:define-constant-profile-material "nanowireDopingPlacement" "nanowireDoping" "Nanowires_v2")

(sdedr:define-constant-profile "MEODoping" "BoronActiveConcentration" 9e+18)
(sdedr:define-constant-profile-material "MEODopingPlacement" "MEODoping" "MEO_2PACz")

(sdedr:define-constant-profile "PcbmDoping" "ArsenicActiveConcentration" 2.2e+18)
